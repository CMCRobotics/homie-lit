...
var require_loglevel = __commonJS(function(exports2, module2) {
  (function(root, definition) {
    ...
    defaultLogger.getLogger = function getLogger(name2) {
      ...
      if (!logger) {
        logger = _loggersByName[name2] = new Logger(name2, defaultLogger.methodFactory);
      }
      return logger;
    };
...
__export(exports_src, {
  ...
  HomieDeviceElement: () => HomieDeviceElement,
  HomieNode: () => HomieNode,
  HomieNodeComponent: () => HomieNodeComponent,
  HomieObserver: () => HomieObserver,
  HomieProperty: () => HomieProperty,
  HomiePropertyBuffer: () => HomiePropertyBuffer,
  PropertyBindingManager: () => PropertyBindingManager,
  createMqttHomieObserver: () => createMqttHomieObserver,
  default: () => src_default,
...
class o {
  ...
  get styleSheet() {
    ...
    if (e && t === undefined) {
      ...
      e && (t = n.get(s)), t === undefined && ((this.o = t = new CSSStyleSheet).replaceSync(this.cssText), e && n.set(s, t));
    }
    return t;
  }
  toString() {
...
var r = (t) => new o(typeof t == "string" ? t : t + "", undefined, s);
var i = (t, ...e) => {
  const n = t.length === 1 ? t[0] : e.reduce((e, s, n) => e + ((t) => {
...
var S = (s, n) => {
  e ? s.adoptedStyleSheets = n.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet) : n.forEach((e) => {
    ...
    o !== undefined && n.setAttribute("nonce", o), n.textContent = e.cssText, s.appendChild(n);
  });
};
...
class u extends HTMLElement {
  ...
  static addInitializer(t) {
    var i;
    this.finalize(), ((i = this.h) !== null && i !== undefined ? i : this.h = []).push(t);
  }
  static get observedAttributes() {
    ...
    return this.elementProperties.forEach((i, s) => {
      ...
      e !== undefined && (this._$Ev.set(e, s), t.push(e));
    }), t;
  }
  static createProperty(t, i = l) {
    if (i.state && (i.attribute = false), this.finalize(), this.elementProperties.set(t, i), !i.noAccessor && !this.prototype.hasOwnProperty(t)) {
      const s = typeof t == "symbol" ? Symbol() : "__" + t, e = this.getPropertyDescriptor(t, s, i);
      e !== undefined && Object.defineProperty(this.prototype, t, e);
    }
  }
  ...
  static finalize() {
    ...
    if (t.finalize(), t.h !== undefined && (this.h = [...t.h]), this.elementProperties = new Map(t.elementProperties), this._$Ev = new Map, this.hasOwnProperty("properties")) {
  ...
  _$Eu() {
    var t;
    this._$E_ = new Promise((t) => this.enableUpdating = t), this._$AL = new Map, this._$Eg(), this.requestUpdate(), (t = this.constructor.h) === null || t === undefined || t.forEach((t) => t(this));
  }
  addController(t) {
    var i, s;
    ((i = this._$ES) !== null && i !== undefined ? i : this._$ES = []).push(t), this.renderRoot !== undefined && this.isConnected && ((s = t.hostConnected) === null || s === undefined || s.call(t));
  }
  removeController(t) {
    var i;
    (i = this._$ES) === null || i === undefined || i.splice(this._$ES.indexOf(t) >>> 0, 1);
  }
  _$Eg() {
  ...
  createRenderRoot() {
    var t;
    const s = (t = this.shadowRoot) !== null && t !== undefined ? t : this.attachShadow(this.constructor.shadowRootOptions);
    return S(s, this.constructor.elementStyles), s;
  }
  connectedCallback() {
    var t;
    this.renderRoot === undefined && (this.renderRoot = this.createRenderRoot()), this.enableUpdating(true), (t = this._$ES) === null || t === undefined || t.forEach((t) => {
      var i;
      return (i = t.hostConnected) === null || i === undefined ? undefined : i.call(t);
    });
  }
  enableUpdating(t) {}
  disconnectedCallback() {
    var t;
    (t = this._$ES) === null || t === undefined || t.forEach((t) => {
      var i;
      return (i = t.hostDisconnected) === null || i === undefined ? undefined : i.call(t);
    });
  }
  ...
  _$EO(t, i, s = l) {
    ...
    if (r !== undefined && s.reflect === true) {
      const h = (((e = s.converter) === null || e === undefined ? undefined : e.toAttribute) !== undefined ? s.converter : n2).toAttribute(i, s.type);
      this._$El = t, h == null ? this.removeAttribute(r) : this.setAttribute(r, h), this._$El = null;
    }
  }
  _$AK(t, i) {
    var s;
    const e = this.constructor, r = e._$Ev.get(t);
    if (r !== undefined && this._$El !== r) {
      const t = e.getPropertyOptions(r), h = typeof t.converter == "function" ? { fromAttribute: t.converter } : ((s = t.converter) === null || s === undefined ? undefined : s.fromAttribute) !== undefined ? t.converter : n2;
      this._$El = r, this[r] = h.fromAttribute(i, t.type), this._$El = null;
    }
  }
  requestUpdate(t, i, s) {
    let e = true;
    t !== undefined && (((s = s || this.constructor.getPropertyOptions(t)).hasChanged || a)(this[t], i) ? (this._$AL.has(t) || this._$AL.set(t, i), s.reflect === true && this._$El !== t && (this._$EC === undefined && (this._$EC = new Map), this._$EC.set(t, s))) : e = false), !this.isUpdatePending && e && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
  ...
  performUpdate() {
    ...
    if (!this.isUpdatePending)
      return;
    this.hasUpdated, this._$Ei && (this._$Ei.forEach((t, i) => this[i] = t), this._$Ei = undefined);
    let i = false;
    const s = this._$AL;
    try {
      i = this.shouldUpdate(s), i ? (this.willUpdate(s), (t = this._$ES) === null || t === undefined || t.forEach((t) => {
        var i;
        return (i = t.hostUpdate) === null || i === undefined ? undefined : i.call(t);
  ...
  _$AE(t) {
    var i;
    (i = this._$ES) === null || i === undefined || i.forEach((t) => {
      var i;
      return (i = t.hostUpdated) === null || i === undefined ? undefined : i.call(t);
  ...
  update(t) {
    this._$EC !== undefined && (this._$EC.forEach((t, i) => this._$EO(i, this[i], t)), this._$EC = undefined), this._$Ek();
  }
  updated(t) {}
  firstUpdated(t) {}
}
...
var e3 = s3 ? s3.createPolicy("lit-html", { createHTML: (t) => t }) : undefined;
var o3 = "$lit$";
...
var d2 = (t) => t === null || typeof t != "object" && typeof t != "function";
var c2 = Array.isArray;
var v = (t) => c2(t) || typeof (t == null ? undefined : t[Symbol.iterator]) == "function";
var a2 = `[ 	
\f\r]`;
...
var w = (t) => (i, ...s) => ({ _$litType$: t, strings: i, values: s });
var x = w(1);
var b = w(2);
...
var V = (t, i) => {
  ...
  for (let i = 0;i < s; i++) {
    const s = t[i];
    let d, c, v = -1, a = 0;
    for (;a < s.length && (u.lastIndex = a, c = u.exec(s), c !== null); )
      a = u.lastIndex, u === f ? c[1] === "!--" ? u = _ : c[1] !== undefined ? u = m : c[2] !== undefined ? (y.test(c[2]) && (l = RegExp("</" + c[2], "g")), u = p) : c[3] !== undefined && (u = p) : u === p ? c[0] === ">" ? (u = l != null ? l : f, v = -1) : c[1] === undefined ? v = -2 : (v = u.lastIndex - c[2].length, d = c[1], u = c[3] === undefined ? p : c[3] === '"' ? $ : g) : u === $ || u === g ? u = p : u === _ || u === m ? u = f : (u = p, l = undefined);
    const w = u === p && t[i + 1].startsWith("/>") ? " " : "";
    r += u === f ? s + h2 : v >= 0 ? (e.push(d), s.slice(0, v) + o3 + s.slice(v) + n3 + w) : s + n3 + (v === -2 ? (e.push(undefined), i) : w);
  }
  return [P(t, r + (t[s] || "<?>") + (i === 2 ? "</svg>" : "")), e];
};
...
class N {
  constructor({ strings: t, _$litType$: i }, e) {
    ...
    if (this.el = N.createElement(a, e), C.currentNode = this.el.content, i === 2) {
      const t = this.el.content, i = t.firstChild;
      i.remove(), t.append(...i.childNodes);
    }
    for (;(h = C.nextNode()) !== null && v.length < c; ) {
      if (h.nodeType === 1) {
        if (h.hasAttributes()) {
          const t = [];
          for (const i of h.getAttributeNames())
            if (i.endsWith(o3) || i.startsWith(n3)) {
              const s = f[d++];
              if (t.push(i), s !== undefined) {
                const t = h.getAttribute(s.toLowerCase() + o3).split(n3), i = /([.?@])?(.*)/.exec(s);
                v.push({ type: 1, index: r, name: i[2], strings: t, ctor: i[1] === "." ? H : i[1] === "?" ? L : i[1] === "@" ? z : k });
              } else
                v.push({ type: 6, index: r });
            }
          for (const i of t)
            h.removeAttribute(i);
        }
        if (y.test(h.tagName)) {
          const t = h.textContent.split(n3), i = t.length - 1;
          if (i > 0) {
            h.textContent = s3 ? s3.emptyScript : "";
            for (let s = 0;s < i; s++)
              h.append(t[s], u2()), C.nextNode(), v.push({ type: 2, index: ++r });
            h.append(t[i], u2());
          }
        }
        ...
        if (h.data === l2)
          ...
          let t = -1;
          for (;(t = h.data.indexOf(n3, t + 1)) !== -1; )
            v.push({ type: 7, index: r }), t += n3.length - 1;
        }
      r++;
    }
  }
  static createElement(t, i) {
    const s = r3.createElement("template");
    return s.innerHTML = t, s;
  }
}
function S2(t, i, s = t, e) {
  var o, n, l, h;
  if (i === T)
    return i;
  let r = e !== undefined ? (o = s._$Co) === null || o === undefined ? undefined : o[e] : s._$Cl;
  const u = d2(i) ? undefined : i._$litDirective$;
  return (r == null ? undefined : r.constructor) !== u && ((n = r == null ? undefined : r._$AO) === null || n === undefined || n.call(r, false), u === undefined ? r = undefined : (r = new u(t), r._$AT(t, s, e)), e !== undefined ? ((l = (h = s)._$Co) !== null && l !== undefined ? l : h._$Co = [])[e] = r : s._$Cl = r), r !== undefined && (i = S2(t, r._$AS(t, i.values), r, e)), i;
}
...
class M {
  ...
  u(t) {
    var i;
    const { el: { content: s }, parts: e } = this._$AD, o = ((i = t == null ? undefined : t.creationScope) !== null && i !== undefined ? i : r3).importNode(s, true);
    C.currentNode = o;
    let n = C.nextNode(), l = 0, h = 0, u = e[0];
    for (;u !== undefined; ) {
      if (l === u.index) {
        let i;
        u.type === 2 ? i = new R(n, n.nextSibling, this, t) : u.type === 1 ? i = new u.ctor(n, u.name, u.strings, this, t) : u.type === 6 && (i = new Z(n, this, t)), this._$AV.push(i), u = e[++h];
      }
      l !== (u == null ? undefined : u.index) && (n = C.nextNode(), l++);
    }
    return C.currentNode = r3, o;
  }
  v(t) {
    let i = 0;
...
class R {
  constructor(t, i, s, e) {
    var o;
    this.type = 2, this._$AH = A, this._$AN = undefined, this._$AA = t, this._$AB = i, this._$AM = s, this.options = e, this._$Cp = (o = e == null ? undefined : e.isConnected) === null || o === undefined || o;
  }
  get _$AU() {
    var t, i;
    return (i = (t = this._$AM) === null || t === undefined ? undefined : t._$AU) !== null && i !== undefined ? i : this._$Cp;
  }
  get parentNode() {
    let t = this._$AA.parentNode;
    const i = this._$AM;
    return i !== undefined && (t == null ? undefined : t.nodeType) === 11 && (t = i.parentNode), t;
  }
  get startNode() {
    return this._$AA;
  }
  ...
  _$AI(t, i = this) {
    t = S2(this, t, i), d2(t) ? t === A || t == null || t === "" ? (this._$AH !== A && this._$AR(), this._$AH = A) : t !== this._$AH && t !== T && this._(t) : t._$litType$ !== undefined ? this.g(t) : t.nodeType !== undefined ? this.$(t) : v(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== A && d2(this._$AH) ? this._$AA.nextSibling.data = t : this.$(r3.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var i;
    const { values: s, _$litType$: e } = t, o = typeof e == "number" ? this._$AC(t) : (e.el === undefined && (e.el = N.createElement(P(e.h, e.h[0]), this.options)), e);
    if (((i = this._$AH) === null || i === undefined ? undefined : i._$AD) === o)
      this._$AH.v(s);
    else {
  ...
  _$AC(t) {
    ...
    return i === undefined && E.set(t.strings, i = new N(t)), i;
  }
  T(t) {
    ...
    let s, e = 0;
    for (const o of t)
      e === i.length ? i.push(s = new R(this.k(u2()), this.k(u2()), this, this.options)) : s = i[e], s._$AI(o), e++;
    e < i.length && (this._$AR(s && s._$AB.nextSibling, e), i.length = e);
  }
  _$AR(t = this._$AA.nextSibling, i) {
    var s;
    for ((s = this._$AP) === null || s === undefined || s.call(this, false, true, i);t && t !== this._$AB; ) {
  ...
  setConnected(t) {
    var i;
    this._$AM === undefined && (this._$Cp = t, (i = this._$AP) === null || i === undefined || i.call(this, t));
  }
}

class k {
  constructor(t, i, s, e, o) {
    this.type = 1, this._$AH = A, this._$AN = undefined, this.element = t, this.name = i, this._$AM = e, this.options = o, s.length > 2 || s[0] !== "" || s[1] !== "" ? (this._$AH = Array(s.length - 1).fill(new String), this.strings = s) : this._$AH = A;
  }
  get tagName() {
  ...
  _$AI(t, i = this, s, e) {
    ...
    let n = false;
    if (o === undefined)
      t = S2(this, t, i, 0), n = !d2(t) || t !== this._$AH && t !== T, n && (this._$AH = t);
    else {
      const e = t;
      let l, h;
      for (t = o[0], l = 0;l < o.length - 1; l++)
        h = S2(this, e[s + l], i, l), h === T && (h = this._$AH[l]), n || (n = !d2(h) || h !== this._$AH[l]), h === A ? t = A : t !== A && (t += (h != null ? h : "") + o[l + 1]), this._$AH[l] = h;
    }
    n && !e && this.j(t);
  }
  j(t) {
    t === A ? this.element.removeAttribute(this.name) : this.element.setAttribute(this.name, t != null ? t : "");
  }
}
...
class z extends k {
  ...
  _$AI(t, i = this) {
    var s;
    if ((t = (s = S2(this, t, i, 0)) !== null && s !== undefined ? s : A) === T)
      return;
  ...
  handleEvent(t) {
    var i, s;
    typeof this._$AH == "function" ? this._$AH.call((s = (i = this.options) === null || i === undefined ? undefined : i.host) !== null && s !== undefined ? s : this.element, t) : this._$AH.handleEvent(t);
  }
}
...
var D = (t, i, s) => {
  var e, o;
  const n = (e = s == null ? undefined : s.renderBefore) !== null && e !== undefined ? e : i;
  let l = n._$litPart$;
  if (l === undefined) {
    const t = (o = s == null ? undefined : s.renderBefore) !== null && o !== undefined ? o : null;
    n._$litPart$ = l = new R(i.insertBefore(u2(), t), t, undefined, s != null ? s : {});
  }
  return l._$AI(t), l;
};
...
class s4 extends u {
  ...
  createRenderRoot() {
    ...
    return (t = (e = this.renderOptions).renderBefore) !== null && t !== undefined || (e.renderBefore = i.firstChild), i;
  }
  update(t) {
    const i = this.render();
  ...
  connectedCallback() {
    var t;
    super.connectedCallback(), (t = this._$Do) === null || t === undefined || t.setConnected(true);
  }
  disconnectedCallback() {
    var t;
    super.disconnectedCallback(), (t = this._$Do) === null || t === undefined || t.setConnected(false);
  }
  render() {
    return T;
  }
...
var e4 = (e) => (n) => typeof n == "function" ? ((e, n) => (customElements.define(e, n), n))(e, n) : ((e, n) => {
  const { kind: t, elements: s } = n;
  return { kind: t, elements: s, finisher(n) {
    customElements.define(e, n);
  } };
})(e, n);
// node_modules/@lit/reactive-element/decorators/property.js
var i3 = (i, e) => e.kind === "method" && e.descriptor && !("value" in e.descriptor) ? { ...e, finisher(n) {
...
function n5(n) {
  return (t, o) => o !== undefined ? e5(n, t, o) : i3(n, t);
}
// node_modules/@lit/reactive-element/decorators/query-assigned-elements.js
var n6;
var e6 = ((n6 = window.HTMLSlotElement) === null || n6 === undefined ? undefined : n6.prototype.assignedElements) != null ? (o, n) => o.assignedElements(n) : (o, n) => o.assignedNodes(n).filter((o) => o.nodeType === Node.ELEMENT_NODE);
...
class PropertyBindingManager {
  ...
  registerTransformer(name2, transformer) {
    this.transformers.set(name2, transformer);
  }
  getTransformer(name2) {
    return this.transformers.get(name2);
  }
  setupSubscription() {
    if (this.observer) {
  ...
  render() {
    const template = x`
      <div class="homie-node">
        ...
        ${this.node.getAllProperties().map((prop) => x`
          <div class="property">
            <span>${prop.name}: </span>
...
class HomieDeviceElement extends s4 {
  constructor() {
    super(...arguments);
  }
  static styles = i`
  ...
  render() {
    return x`
      <div class="homie-device">
        ${this.device?.getAllNodes().map((node) => x`
...
class HomieProperty {
  constructor(id, name2 = id, value, dataType, format = "") {
    this.id = id;
    this.name = name2;
    this.value = value;
...
function errorContext(cb) {
  if (config.useDeprecatedSynchronousErrorHandling) {
    ...
    cb();
    if (isRoot) {
      var _a = context, { errorThrown, error } = _a;
      context = null;
      if (errorThrown) {
        throw error;
      }
...
var Observable = function() {
  ...
  Observable.prototype.subscribe = function(observerOrNext, error, complete) {
    ...
    errorContext(function() {
      var _a = _this, { operator, source } = _a;
...
var Subject = function(_super) {
  ...
  Subject.prototype._innerSubscribe = function(subscriber) {
    var _this = this;
    var _a = this, { hasError, isStopped, observers } = _a;
  ...
  Subject.prototype._checkFinalizedStatuses = function(subscriber) {
    var _a = this, { hasError, thrownError, isStopped } = _a;
    if (hasError) {
...
var M2 = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports);
var Jt = (t, e) => {
  for (var r in e)
...
var Hu = _e(() => {
  ...
  Ol = "browser", xl = "x64", Ml = "browser", Ll = { PATH: "/usr/bin", LANG: navigator.language + ".UTF-8", PWD: "/", HOME: "/home", TMP: "/tmp" }, Ul = ["/usr/bin/node"], Nl = [], ql = "v16.8.0", Dl = {}, jl = function(t, e) {
    ...
    return "/";
  }, Hl = function(t) {}, Vl = { name: "node", sourceUrl: "", headersUrl: "", libUrl: "" };
  zl = Ee, Kl = [];
  Ql = {}, Yl = false, Jl = {};
...
var me = {};
Jt(me, { Buffer: () => x2, INSPECT_MAX_BYTES: () => ty, default: () => Ut, kMaxLength: () => ry });
function Xg() {
  if (Vu)
    return ci;
...
var be = _e(() => {
  ...
  Ut.kMaxLength;
  x2 = Ut.Buffer, ty = Ut.INSPECT_MAX_BYTES, ry = Ut.kMaxLength;
});
var v2 = _e(() => {
  be();
});
...
var Je = M2(($A, Ss) => {
  ...
  v2();
  m2();
  var iy = (be(), X(me)), ny = Object.getPrototypeOf(async function() {}).constructor, Yu = globalThis.Blob || iy.Blob, sy = typeof Yu < "u" ? function(e) {
...
var vt = M2((QI, Ns) => {
  ...
  function jf(t, e, r) {
    ...
    let o = (i = e.readable) !== null && i !== undefined ? i : xs(t), s = (n = e.writable) !== null && n !== undefined ? n : Uf(t), { _writableState: a, _readableState: l } = t, c = () => {
      t.writable || g();
...
var ho = M2((fR, ch) => {
  ...
  function j_(t, e) {
    let r = t._writableState, { sync: i, writecb: n } = r;
...
var ot = M2((xe, Bn) => {
  ...
  function Rm() {
    ...
    return !t && typeof B2 < "u" && "env" in B2 && (t = B2.env.DEBUG), t;
  }
  function Cm() {
    try {
      return localStorage;
...
var Id = M2((ik, zo) => {
  ...
  v2();
  m2();
  typeof B2 > "u" || !B2.version || B2.version.indexOf("v0.") === 0 || B2.version.indexOf("v1.") === 0 && B2.version.indexOf("v1.8.") !== 0 ? zo.exports = { nextTick: Nm } : zo.exports = B2;
  function Nm(t, e, r, i) {
    if (typeof t != "function")
...
var Qo = M2((dk, xd) => {
  ...
  v2();
  m2();
  var j = Ho(), { Buffer: q } = (be(), X(me)), qm = q.allocUnsafe(0), Dm = q.from([0]), Ai = Ad(), jm = Id().nextTick, qe = ot()("mqtt-packet:writeToStream"), { cache: Pn, generateNumber: Fm, generateCache: Wm, genBufVariableByteInt: Ko, generate4ByteBuffer: $m } = Ai, Te = Go, kn = true;
  function kd(t, e, r) {
  ...
  function Vm(t, e, r) {
    let i = t || {}, n = i.protocolId || "MQTT", o = i.protocolVersion || 4, { will: s, clean: a } = i, l = i.keepalive || 0, c = i.clientId || "", { username: h, password: d, properties: g } = i;
    a === undefined && (a = true);
    let y = 0;
  ...
  function Km(t, e, r) {
    ...
    let i = r ? r.protocolVersion : 4, n = t || {}, o = n.qos || 0, s = n.retain ? j.RETAIN_MASK : 0, a = n.topic, l = n.payload || qm, { messageId: c, properties: h } = n, d = 0;
    if (typeof a == "string")
      d += q.byteLength(a) + 2;
  ...
  function Gm(t, e, r) {
    let i = r ? r.protocolVersion : 4, n = t || {}, o = n.cmd || "puback", s = n.messageId, a = n.dup && o === "pubrel" ? j.DUP_MASK : 0, l = 0, { reasonCode: c, properties: h } = n, d = i === 5 ? 3 : 2;
  ...
  function Qm(t, e, r) {
    qe("subscribe: packet: ");
    let i = r ? r.protocolVersion : 4, n = t || {}, o = n.dup ? j.DUP_MASK : 0, { messageId: s, subscriptions: a, properties: l } = n, c = 0;
    if (typeof s != "number")
      return e.destroy(new Error("Invalid messageId")), false;
    c += 2;
    let h = null;
  ...
  function Ym(t, e, r) {
    let i = r ? r.protocolVersion : 4, n = t || {}, { messageId: o, granted: s, properties: a } = n, l = 0;
    if (typeof o != "number")
      return e.destroy(new Error("Invalid messageId")), false;
  ...
  function Jm(t, e, r) {
    let i = r ? r.protocolVersion : 4, n = t || {}, o = n.messageId, s = n.dup ? j.DUP_MASK : 0, { unsubscriptions: a, properties: l } = n, c = 0;
    if (typeof o != "number")
      return e.destroy(new Error("Invalid messageId")), false;
  ...
  function Xm(t, e, r) {
    let i = r ? r.protocolVersion : 4, n = t || {}, o = n.messageId, s = n.dup ? j.DUP_MASK : 0, { granted: a, properties: l, cmd: c } = n, h = 0, d = 2;
    if (typeof o != "number")
      return e.destroy(new Error("Invalid messageId")), false;
    if (i === 5)
      if (typeof a == "object" && a.length)
  ...
  function e1(t, e, r) {
    let i = r ? r.protocolVersion : 4, n = t || {}, { reasonCode: o, properties: s } = n, a = i === 5 ? 1 : 0, l = null;
    if (i === 5) {
      if (l = Ii(e, s, r, a), !l)
        return false;
      a += l.length;
  ...
  function t1(t, e, r) {
    let i = r ? r.protocolVersion : 4, n = t || {}, { reasonCode: o, properties: s } = n, a = i === 5 ? 1 : 0;
...
var Dd = M2((Zk, qd) => {
  ...
  qd.exports = a1;
  function Jr(t) {
    return t instanceof x2 ? x2.from(t) : new t.constructor(t.buffer.slice(), t.byteOffset, t.length);
  }
  function a1(t) {
    if (t = t || {}, t.circles)
      return l1(t);
...
var _r = M2((at) => {
  ...
  at.applyMixin = g1;
  at.nextTick = typeof (B2 === null || B2 === undefined ? undefined : B2.nextTick) == "function" ? B2.nextTick : (t) => {
    setTimeout(t, 0);
  };
...
var ep = M2((Mn) => {
  ...
  var Ri = typeof performance == "object" && performance && typeof performance.now == "function" ? performance : Date, Jd = new Set, oa = typeof B2 == "object" && B2 ? B2 : {}, Xd = (t, e, r, i) => {
    typeof oa.emitWarning == "function" ? oa.emitWarning(t, e, r, i) : console.error(`[${r}] ${e}: ${t}`);
  }, { AbortController: xn, AbortSignal: Yd } = globalThis;
  if (typeof xn > "u") {
    Yd = class {
      onabort;
      _onabort = [];
...
var Oi = M2((Tr) => {
  ...
  var qv = () => {
    var t;
    return typeof window < "u" ? typeof navigator < "u" && ((t = navigator.userAgent) === null || t === undefined ? undefined : t.toLowerCase().indexOf(" electron/")) > -1 && (!(B2 === null || B2 === undefined) && B2.versions) ? !Object.prototype.hasOwnProperty.call(B2.versions, "electron") : typeof window.document < "u" : false;
  }, Cp = () => {
    var t, e;
...
var xp = M2((rs, Op) => {
  ...
  (function(t, e) {
    ...
    var r = function(s) {
      ...
      var a = new Map([[0, function() {}]]), l = new Map([[0, function() {}]]), c = new Map, h = new Worker(s);
      h.addEventListener("message", function(S) {
        var E = S.data;
        if (r(E)) {
          var I = E.params, { timerId: C, timerType: R } = I;
          if (R === "interval") {
            var U = a.get(C);
            if (typeof U == "number") {
              var N = c.get(U);
...
var gg = {};
Jt(gg, { URL: () => FE, Url: () => UE, default: () => Z2, fileURLToPath: () => dg, format: () => NE, parse: () => jE, pathToFileURL: () => pg, resolve: () => qE, resolveObject: () => DE });
function Fe() {
...
var yg = _e(() => {
  ...
  ag();
  Ja();
  Z2 = {}, hE = Kt, gt = { isString: function(t) {
  ...
  Z2.parse = Li, Z2.resolve = function(t, e) {
    return Li(t, false, true).resolve(e);
  }, Z2.resolveObject = function(t, e) {
    return t ? Li(t, false, true).resolveObject(e) : e;
  }, Z2.format = function(t) {
...
`, "\t"]), il = ["'"].concat(yE), lg = ["%", "/", "?", ";", "#"].concat(il), ug = ["/", "?", "#"], fg = /^[+a-z0-9A-Z_-]{0,63}$/, bE = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, wE = { javascript: true, "javascript:": true }, el = { javascript: true, "javascript:": true }, ai = { http: true, https: true, ftp: true, gopher: true, file: true, "http:": true, "https:": true, "ftp:": true, "gopher:": true, "file:": true }, tl = pt;
  ...
  Z2.pathToFileURL = pg;
  Z2.fileURLToPath = dg;
  UE = Z2.Url, NE = Z2.format, qE = Z2.resolve, DE = Z2.resolveObject, jE = Z2.parse, FE = Z2.URL, WE = 92, $E = 47, HE = 97, VE = 122, sl = LE === "win32", zE = /\//g, KE = /%/g, GE = /\\/g, QE = /\n/g, YE = /\r/g, JE = /\t/g;
});
var wg = M2((m8, bg) => {
  _2();
  v2();
...
var kg = M2((Br) => {
  ...
  typeof (B2 === null || B2 === undefined ? undefined : B2.nextTick) != "function" && (B2.nextTick = setImmediate);
...
class MqttClient {
  constructor(brokerUrl, options = {}, messageCallback, onConnectCallback, onDisconnectCallback) {
    this.client = mqtt_esm_default.connect(brokerUrl);
...
var asyncScheduler2 = new AsyncScheduler(AsyncAction);
...
function bufferTime2(bufferTimeSpan) {
  ...
  var scheduler = (_a = popScheduler(otherArgs)) !== null && _a !== undefined ? _a : asyncScheduler2;
  ...
  return operate(function(source, subscriber) {
    ...
    var bufferTimeSubscriber = createOperatorSubscriber(subscriber, function(value) {
      ...
      try {
        ...
        try {
          if (recordsCopy_1_1 && !recordsCopy_1_1.done && (_a = recordsCopy_1.return))
...
function tap2(observerOrNext, error, complete) {
  ...
  return tapObserver ? operate(function(source, subscriber) {
    ...
    source.subscribe(createOperatorSubscriber(subscriber, function(value) {
      var _a;
      (_a = tapObserver.next) === null || _a === undefined || _a.call(tapObserver, value);
      subscriber.next(value);
    }, function() {
      var _a;
      isUnsub = false;
      (_a = tapObserver.complete) === null || _a === undefined || _a.call(tapObserver);
      subscriber.complete();
    }, function(err) {
      var _a;
      isUnsub = false;
      (_a = tapObserver.error) === null || _a === undefined || _a.call(tapObserver, err);
      subscriber.error(err);
    }, function() {
      var _a, _b;
      if (isUnsub) {
        (_a = tapObserver.unsubscribe) === null || _a === undefined || _a.call(tapObserver);
      }
...
class HomiePropertyBuffer {
  ...
  setupPropertyUpdateStream() {
    ...
    merge(this.homieObserver.created$, this.homieObserver.updated$).pipe(tap2((event) => logger_default.debug("Received event in setupPropertyUpdateStream", { event })), filter2((event) => event.type === "property" /* Property */), map((event) => {
  ...
  setupBufferedUpdatesStream() {
    ...
    return this.propertyUpdates$.pipe(tap2(() => logger_default.debug("propertyUpdates$ emitted a value")), bufferTime2(this.bufferTimeMs), tap2((updates) => logger_default.debug("Buffered updates", { updates })), filter2((updates) => updates.length > 0), map((updates) => {
...
globalThis.HomieLit = exports_src;

//# debugId=D285AB1864D0480064756E2164756E21
